...
if [ ! -d crate-0.31.0 ]; then
    prf "\n* Downloading CRATE...\n"
    curl -f https://cdn.crate.io/downloads/releases/crate-0.31.0.tar.gz > crate-0.31.0.tar.gz
    tar xzf crate-0.31.0.tar.gz
else
